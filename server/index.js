...
const EXTRACT_CLIENT_INVOICE_TOOL = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      totalSaleLineAsPrinted: { type: 'string', description: 'The complete text of the line showing the Total Sale/Subtotal, exactly as printed, e.g. "Subtotal    $412.00". This must be a literal transcription of text visible on the page -- copy it, do not summarize or compute it. Leave as an empty string if no such line exists; in that case totalSale must be 0.' },
